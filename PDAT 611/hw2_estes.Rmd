...
nycKirksville
```
This is not surprising. O'Hare is one of the 5 busiest airports in the US. 
DSM is the least busy airport in the list and is the smallest airport of the five listed.
The middle three are all small-to-mid sized airports and fit correspondingly in the chart above.
...
\newpage
For my additional research I used the boxplot functions to create a neat correlation graph between the areas and total square feet of a property. The Total Sqare Feet excludes Lot Area as I wanted to focus on living/habitable space
```{r, warning=FALSE, error=FALSE}
