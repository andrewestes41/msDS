...
Newer versions of the sf package want a newer style of CRS, and warnings will
suggest you do something like this to recreate the CRS if the CRS is
"old-style."

```{r}
st_crs(trails) <- st_crs(trails)
st_crs(franconia) <- st_crs(franconia)
st_crs(breweries) <- st_crs(breweries)
```
...
Here are the default aesthetic choices form Leaflet.
